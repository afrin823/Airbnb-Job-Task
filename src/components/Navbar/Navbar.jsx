  ...
  return (
    <header className="w-full border-b bg-white shadow-sm">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-8 py-3">
        {/* Logo */}
        <div className="flex items-center text-rose-500 text-3xl gap-1">
          <SiAirbnb /> <span className="font-medium"> airbnb</span>
        </div>
      ...
      <div className="flex justify-center mt-3 pb-4 px-3">
        <div className="flex flex-col sm:flex-row sm:items-center bg-white shadow-md rounded-full overflow-hidden px-3 py-2 sm:space-x-2 w-full max-w-2xl">
          {/* Where */}
          <div className="flex-1 px-3 py-1 border-b sm:border-b-0 sm:border-r text-center sm:text-left">
          ...
          <div className="flex-1 px-3 py-1 flex items-center justify-between">
            ...
            <button className="bg-rose-500 text-white p-2 rounded-full hover:bg-rose-600 ml-3">
              <FiSearch size={16} />
            </button>
          </div>
        </div>
